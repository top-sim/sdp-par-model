...
\m  \mathrm{SDPInRate(SKA1Survey)}=4.48\;{{\mathrm{Tbyte}}\over{\mathrm{s}}} \\
\end{maxima}
...
\m  \mathrm{SDPInUnit(SKA1Survey)}=1.216 \times 10^{+7}\;\mathrm{byte} \\
\end{maxima}
...
\m  \mathrm{SDPUVChunk(SKA1Survey)}=4.864 \times 10^{+8}\;\mathrm{byte} \\
\end{maxima}

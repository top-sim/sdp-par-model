...
\m  {{\left(N_{\rm a}-1\right)\,N_{\rm a}\,N_{\rm beam}\,N_{\rm f}}\over{62500000000\,t_{\rm dump}}}\;\mathrm{Tbyte} \\
\m  {{16\,\left(N_{\rm a}-1\right)\,N_{\rm a}\,N_{\rm beam}\,N_{\rm f}}\over{t_{\rm dump}}}\;\mathrm{byte} \\
\m  \mathrm{SDPInRate(SKA1Low)}=7.2\;{{\mathrm{Tbyte}}\over{\mathrm{s}}} \\
\m  \mathrm{SDPInRate(SKA1Mid)}=3.3\;{{\mathrm{Tbyte}}\over{\mathrm{s}}} \\
\m  \mathrm{SDPInRate(SKA1Survey)}=4.5\;{{\mathrm{Tbyte}}\over{\mathrm{s}}} \\
\end{maxima}
...
\maximaoutput*
\m  {{27\,\left(N_{\rm a}-1\right)\,N_{\rm a}\,N_{\rm beam}\,N_{\rm f}}\over{39062500\,t_{\rm dump}}}\;\mathrm{Tbyte}\,\mathrm{s} \\
\m  \mathrm{SDPUVBufSize(SKA1Low)}=308936.\;\mathrm{Tbyte} \\
\m  \mathrm{SDPUVBufSize(SKA1Mid)}=142137.\;\mathrm{Tbyte} \\
\m  \mathrm{SDPUVBufSize(SKA1Survey)}=193651.\;\mathrm{Tbyte} \\
\m  309.\;\mathrm{Pbyte} \\
\m  142.\;\mathrm{Pbyte} \\
\m  194.\;\mathrm{Pbyte} \\
\end{maxima}
...
\maximaoutput*
\m  {{4\,\left(N_{\rm a}-1\right)\,N_{\rm a}}\over{t_{\rm dump}}}\;\mathrm{byte} \\
\m  {{400\,\left(N_{\rm a}-1\right)\,N_{\rm a}}\over{t_{\rm dump}}}\;\mathrm{s}\,\mathrm{byte} \\
\m  \mathrm{SDPInUnit(SKA1Low)}=6.98 \times 10^{+8}\;\mathrm{byte} \\
\m  \mathrm{SDPInUnit(SKA1Mid)}=3.21 \times 10^{+8}\;\mathrm{byte} \\
\m  \mathrm{SDPInUnit(SKA1Survey)}=1.22 \times 10^{+7}\;\mathrm{byte} \\
\end{maxima}
...
\maximaoutput*
\m  {{16000\,\left(N_{\rm a}-1\right)\,N_{\rm a}}\over{t_{\rm dump}}}\;\mathrm{s}\,\mathrm{byte} \\
\m  \mathrm{SDPUVChunk(SKA1Low)}=2.8 \times 10^{+10}\;\mathrm{byte} \\
\m  \mathrm{SDPUVChunk(SKA1Mid)}=1.3 \times 10^{+10}\;\mathrm{byte} \\
\m  \mathrm{SDPUVChunk(SKA1Survey)}=4.86 \times 10^{+8}\;\mathrm{byte} \\
\m  {{\left(N_{\rm a}-1\right)\,N_{\rm a}\,s}\over{62500\,t_{\rm dump}}}\;\mathrm{Gbyte} \\
\m  28.\;\mathrm{Gbyte} \\
\m  13.\;\mathrm{Gbyte} \\
\m  .49\;\mathrm{Gbyte} \\
\end{maxima}

...
<https://ska-telescope.gitlab.io/sdp/ska-sdp-par-model/notebooks/SKA1_Imaging_Performance_Model.html>`_:
Contains interactive cells for computing telescope parameters (data
rates, FLOPs, image sizes etc).

`SKA1_Sensitivity_Analysis
<https://ska-telescope.gitlab.io/sdp/ska-sdp-par-model/notebooks/SKA1_Sensitivity_Analysis.html>`_:
...
<https://ska-telescope.gitlab.io/sdp/ska-sdp-par-model/notebooks/SKA1_SDP_Performance_Dashboard.html>`_:
Overview of FLOP rate predictions for different telescopes, pipelines
and high-priority science objectives (HPSOs).

`SKA1_Export
<https://ska-telescope.gitlab.io/sdp/ska-sdp-par-model/notebooks/SKA1_Export.html>`_:
...
`SKA1_System_Sizing
<https://ska-telescope.gitlab.io/sdp/ska-sdp-par-model/notebooks/SKA1_System_Sizing.html>`_:
...
`SKA1_SDP_Products
<https://ska-telescope.gitlab.io/sdp/ska-sdp-par-model/notebooks/SKA1_SDP_Products.html>`_,
`SKA1_Document_Formulas
<https://ska-telescope.gitlab.io/sdp/ska-sdp-par-model/notebooks/SKA1_Document_Formulas.html>`_:
...
<https://ska-telescope.gitlab.io/sdp/ska-sdp-par-model/notebooks/Absolute_Baseline_length_distribution.html>`_:

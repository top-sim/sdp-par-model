def compute_derived_parameters(o):
    ...
    o.Gcorr = o.Na * (o.Na - 1) * o.Nf_max * o.Nbeam * Nw * o.Npp / o.Tdump  # Minimum correlator output data rate, after baseline dependent averaging

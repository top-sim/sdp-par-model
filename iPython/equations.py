...
class Equations:
    ...
    def apply_imaging_equations(telescope_parameters, imaging_mode, bl_dep_time_av, on_the_fly=False, verbose=False):
        ...
        o.Theta_fov = 7.66 * o.wl_sb_max * o.Qfov *  (1+using_facet_overlap_frac) / (pi * o.Ds * o.Nfacet)  # Eq 6 - Facet Field-of-view (linear) at fiducial wavelength
        o.Total_fov = 7.66 * o.wl_sb_max * o.Qfov / (pi * o.Ds) # Total linear field of view of map

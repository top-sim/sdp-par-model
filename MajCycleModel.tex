...
A crude first estimate of the computational intensity can be done by
dividing the most largest data set (visibilities) and the computing
requirements computed above. 

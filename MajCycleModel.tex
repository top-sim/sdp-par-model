...
\maximaoutput*
\m  {{4.6 \times 10^{-10}\,\lambda_{\rm max}^3\,N_{\rm beam}\,N_{\rm f}\,Q_{\rm FoV}^3\,\mathrm{Qgcf}^3\,\mathrm{qty}\left({{2.67 \times 10^{-5}\,B_{\rm max}\,\lambda_{\rm max}\,Q_{\rm FoV}\,\mathrm{twsnap}\,\sqrt{{{B_{\rm max}\,\mathrm{twsnap}}\over{\lambda_{\rm min}}}}}\over{\pi\,D_{\rm s}\,\lambda_{\rm min}}}\;{{1}\over{\mathrm{s}^{{{3}\over{2}}}}}+{{1.93 \times 10^{-8}\,B_{\rm max}^2\,\lambda_{\rm max}^2\,Q_{\rm FoV}^2\,\mathrm{twsnap}^2}\over{\pi^2\,D_{\rm s}^2\,\lambda_{\rm min}^2}}\;{{1}\over{\mathrm{s}^2}}\right)^{{{3}\over{2}}}}\over{\pi^3\,D_{\rm s}^3}}\;\mathrm{Pbyte} \\
\m  \mbox{{}KernelCache(SKA1Low,[Qgcf = 8,twsnap = 40 ` s]){}}=0.6\;{{\mathrm{Pbyte}}\over{\mathrm{s}^3\,\mathrm{Hz}^3}} \\
\m  \mbox{{}KernelCache(SKA1Mid,[Qgcf = 8,twsnap = 200 ` s]){}}=23.\;{{\mathrm{Pbyte}}\over{\mathrm{s}^3\,\mathrm{Hz}^3}} \\
\m  \mbox{{}KernelCache(SKA1Survey,[Qgcf = 8,twsnap = 550 ` s]){}}=360.\;{{\mathrm{Pbyte}}\over{\mathrm{s}^3\,\mathrm{Hz}^3}} \\
\m  \mbox{{}KernelCache(SKA1Survey,[Qgcf = 8,twsnap = 100 ` s]){}}=7.3\;{{\mathrm{Pbyte}}\over{\mathrm{s}^3\,\mathrm{Hz}^3}} \\
\end{maxima}

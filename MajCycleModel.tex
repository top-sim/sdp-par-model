...
\maximaoutput*
\m  {{2500.\,B_{\rm max}^2\,\lambda_{\rm max}^2\,\mathrm{QPix}^2\,Q_{\rm FoV}^2}\over{\pi^2\,D_{\rm s}^2\,\lambda_{\rm min}^2}}\;\mathrm{byte} \\
...
\maximaoutput*
\m  {{2.87 \times 10^{-5}\,\lambda_{\rm max}^3\,N_{\rm beam}\,N_{\rm f}\,Q_{\rm FoV}^3\,\mathrm{Qgcf}^2\,\mathrm{qty}\left({{2.67 \times 10^{-5}\,B_{\rm max}\,\lambda_{\rm max}\,Q_{\rm FoV}\,\mathrm{twsnap}\,\sqrt{{{B_{\rm max}\,\mathrm{twsnap}}\over{\lambda_{\rm min}}}}}\over{\pi\,D_{\rm s}\,\lambda_{\rm min}}}\;{{1}\over{\mathrm{s}^{{{3}\over{2}}}}}+{{1.93 \times 10^{-8}\,B_{\rm max}^2\,\lambda_{\rm max}^2\,Q_{\rm FoV}^2\,\mathrm{twsnap}^2}\over{\pi^2\,D_{\rm s}^2\,\lambda_{\rm min}^2}}\;{{1}\over{\mathrm{s}^2}}\right)^{{{3}\over{2}}}}\over{\pi^3\,D_{\rm s}^3}}\;\mathrm{Gbyte} \\
\m  \mbox{{}KernelCache(SKA1Low,[Qgcf = 8,twsnap = 40 ` s]){}}=5300.\;{{\mathrm{Gbyte}}\over{\mathrm{s}^3\,\mathrm{Hz}^3}} \\
\m  \mbox{{}KernelCache(SKA1Mid,[Qgcf = 8,twsnap = 200 ` s]){}}=180000.\;{{\mathrm{Gbyte}}\over{\mathrm{s}^3\,\mathrm{Hz}^3}} \\
\m  \mbox{{}KernelCache(SKA1Survey,[Qgcf = 8,twsnap = 550 ` s]){}}=2800000.\;{{\mathrm{Gbyte}}\over{\mathrm{s}^3\,\mathrm{Hz}^3}} \\
\end{maxima}

...
\maximaoutput*
\m  {{16\,\mathrm{NMm}\,\left(N_{\rm a}-1\right)\,N_{\rm a}\,N_{\rm beam}\,N_{\rm f}\,N_{\rm facet}^2\,\left(\mathrm{qty}\left({{230.\,\mathrm{lambdamax}^2\,\mathrm{Qfov}^2\,\mathrm{qty}\left({{2.67 \times 10^{-5}\,B_{\rm max}\,\mathrm{lambdamax}\,\mathrm{Qfov}\,\mathrm{twsnap}\,\sqrt{{{B_{\rm max}\,\mathrm{twsnap}}\over{\lambda}}}}\over{\pi\,D_{\rm s}\,\lambda}}\;{{1}\over{\mathrm{s}^{{{3}\over{2}}}}}+{{1.93 \times 10^{-8}\,B_{\rm max}^2\,\mathrm{lambdamax}^2\,\mathrm{Qfov}^2\,\mathrm{twsnap}^2}\over{\pi^2\,D_{\rm s}^2\,\lambda^2}}\;{{1}\over{\mathrm{s}^2}}\right)}\over{\pi^2\,D_{\rm s}^2}}\right)+N_{\rm AA}^2\right)}\over{t_{\rm dump}}}\;\mathrm{Ops} \\
\m  \mbox{{}GridRate(SKA1Low,[Nfacet = 1]){}}=7.15 \times 10^{+12}\,\mathrm{NMm}\,\left(0.5\,\left(0.05\,\mathrm{twsnap}^2+7.9\,\mathrm{twsnap}^{{{3}\over{2}}}\right)+81.\right)\;{{\mathrm{Ops}}\over{\mathrm{s}}} \\
\m  \mbox{{}GridRate(SKA1Mid,[Nfacet = 1]){}}=3.29 \times 10^{+12}\,\mathrm{NMm}\,\left(0.02\,\left(1.1\,\mathrm{twsnap}^2+170.\,\mathrm{twsnap}^{{{3}\over{2}}}\right)+81.\right)\;{{\mathrm{Ops}}\over{\mathrm{s}}} \\
\m  \mbox{{}GridRate(SKA1Survey,[Nfacet = 1]){}}=4.48 \times 10^{+12}\,\mathrm{NMm}\,\left(0.02\,\left(0.07\,\mathrm{twsnap}^2+22.\,\mathrm{twsnap}^{{{3}\over{2}}}\right)+81.\right)\;{{\mathrm{Ops}}\over{\mathrm{s}}} \\
\end{maxima}
...
\m  \mathrm{CompRate(SKA1Low)}=\left(7.15 \times 10^{+12}\,\mathrm{NMm}\,N_{\rm facet}^2\,\left(0.5\,\left(0.05\,\mathrm{twsnap}^2+7.9\,\mathrm{twsnap}^{{{3}\over{2}}}\right)+81.\right)\;{{1}\over{\mathrm{s}}}+{{3.64 \times 10^{+17}\,N_{\rm facet}^2}\over{\mathrm{twsnap}}}\right)\;\mathrm{Ops} \\
\m  \mathrm{CompRate(SKA1Mid)}=\left(3.29 \times 10^{+12}\,\mathrm{NMm}\,N_{\rm facet}^2\,\left(0.02\,\left(1.1\,\mathrm{twsnap}^2+170.\,\mathrm{twsnap}^{{{3}\over{2}}}\right)+81.\right)\;{{1}\over{\mathrm{s}}}+{{8.79 \times 10^{+18}\,N_{\rm facet}^2}\over{\mathrm{twsnap}}}\right)\;\mathrm{Ops} \\
\m  \mathrm{CompRate(SKA1Survey)}=\left(4.48 \times 10^{+12}\,\mathrm{NMm}\,N_{\rm facet}^2\,\left(0.02\,\left(0.07\,\mathrm{twsnap}^2+22.\,\mathrm{twsnap}^{{{3}\over{2}}}\right)+81.\right)\;{{1}\over{\mathrm{s}}}+{{1.8 \times 10^{+19}\,N_{\rm facet}^2}\over{\mathrm{twsnap}}}\right)\;\mathrm{Ops} \\
\end{maxima}

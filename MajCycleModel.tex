...
\maximaoutput*
\m  {{256\,B_{\rm max}^2}\over{D_{\rm s}^2\,N_{\rm facet}^2}}\;\mathrm{byte} \\
\m  2.1\;\mathrm{Gbyte} \\
\m  46.\;\mathrm{Gbyte} \\
\m  2.8\;\mathrm{Gbyte} \\
\end{maxima}
...
case would require:
\begin{maxima}[]
ev(TargetGridSize*Nf , append([Nfacet=1], SKA1Low)) `` Pbyte;
ev(TargetGridSize*Nf , append([Nfacet=1], SKA1Mid)) `` Pbyte;
ev(TargetGridSize*Nf , append([Nfacet=1], SKA1Survey)) `` Pbyte;

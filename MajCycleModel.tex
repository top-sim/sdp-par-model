...
\m  \mathrm{FFTRate(SKA1Low)}={{9.6 \times 10^{+14}\,\log \left({{1.31 \times 10^{+8}}\over{N_{\rm facet}^2}}\right)}\over{\mathrm{twsnap}}}\;\mathrm{Ops} \\
\m  \mathrm{FFTRate(SKA1Mid)}={{2.1 \times 10^{+16}\,\log \left({{2.84 \times 10^{+9}}\over{N_{\rm facet}^2}}\right)}\over{\mathrm{twsnap}}}\;\mathrm{Ops} \\
\m  \mathrm{FFTRate(SKA1Survey)}={{4.7 \times 10^{+16}\,\log \left({{1.78 \times 10^{+8}}\over{N_{\rm facet}^2}}\right)}\over{\mathrm{twsnap}}}\;\mathrm{Ops} \\
\m  \mbox{ FFTRate(SKA1Low,[Nfacet = 1,twsnap = 40 ` s]) }=4.5 \times 10^{+14}\;{{\mathrm{Ops}}\over{\mathrm{s}}} \\
\m  \mbox{ FFTRate(SKA1Mid,[Nfacet = 1,twsnap = 200 ` s]) }=2.3 \times 10^{+15}\;{{\mathrm{Ops}}\over{\mathrm{s}}} \\
\m  \mbox{ FFTRate(SKA1Survey,[Nfacet = 1,twsnap = 550 ` s]) }=1.6 \times 10^{+15}\;{{\mathrm{Ops}}\over{\mathrm{s}}} \\
\end{maxima}

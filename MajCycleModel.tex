...
\m  {{1.24 \times 10^{+16}}\over{\log 2\,\mathrm{twsnap}}}\;\mathrm{Ops} \\
\m  {{3.17 \times 10^{+17}}\over{\log 2\,\mathrm{twsnap}}}\;\mathrm{Ops} \\
\m  {{6.22 \times 10^{+17}}\over{\log 2\,\mathrm{twsnap}}}\;\mathrm{Ops} \\
\end{maxima}
...
\m  \mbox{{}ConvToGridRatio(SKA1Low,[Nfacet = 1,twsnap = 40 ` s,Qfcv = 1,Qgcf = 8,[NGCF = sqrt('qty(16*'qty(3.48E-6*Bmax*twsnap*sqrt(Bmax*twsnap/lambda)/Ds ` 1/s^(3/2)+3.3E-10*Bmax^2*twsnap^2/Ds^2 ` 1/s^2)*lambda^2/Ds^2)+NAA^2),FNGCF = Qgcf*NGCF]]){}}={{31.}\over{t_{\rm ionsph}}}\;\mathrm{s} \\
\m  \mbox{{}ConvToGridRatio(SKA1Mid,[Nfacet = 1,twsnap = 200 ` s,Qfcv = 1,Qgcf = 8,[NGCF = sqrt('qty(16*'qty(3.48E-6*Bmax*twsnap*sqrt(Bmax*twsnap/lambda)/Ds ` 1/s^(3/2)+3.3E-10*Bmax^2*twsnap^2/Ds^2 ` 1/s^2)*lambda^2/Ds^2)+NAA^2),FNGCF = Qgcf*NGCF]]){}}={{4.9}\over{t_{\rm ionsph}}}\;\mathrm{s} \\
\m  \mbox{{}ConvToGridRatio(SKA1Survey,[Nfacet = 1,twsnap = 550 ` s,Qfcv = 1,Qgcf = 8,[NGCF = sqrt('qty(16*'qty(3.48E-6*Bmax*twsnap*sqrt(Bmax*twsnap/lambda)/Ds ` 1/s^(3/2)+3.3E-10*Bmax^2*twsnap^2/Ds^2 ` 1/s^2)*lambda^2/Ds^2)+NAA^2),FNGCF = Qgcf*NGCF]]){}}={{17.}\over{t_{\rm ionsph}}}\;\mathrm{s} \\
\end{maxima}
...
\maximaoutput*
\m  \mbox{{}gcfrate(SKA1Low,[Nfacet = 1,twsnap = 40 ` s,Qfcv = 1,Qgcf = 8,[NGCF = sqrt('qty(16*'qty(3.48E-6*Bmax*twsnap*sqrt(Bmax*twsnap/lambda)/Ds ` 1/s^(3/2)+3.3E-10*Bmax^2*twsnap^2/Ds^2 ` 1/s^2)*lambda^2/Ds^2)+NAA^2),FNGCF = Qgcf*NGCF]]){}}={{3.04 \times 10^{+16}}\over{t_{\rm ionsph}}}\;\mathrm{Ops} \\
\m  \mbox{{}gcfrate(SKA1Mid,[Nfacet = 1,twsnap = 200 ` s,Qfcv = 1,Qgcf = 8,[NGCF = sqrt('qty(16*'qty(3.48E-6*Bmax*twsnap*sqrt(Bmax*twsnap/lambda)/Ds ` 1/s^(3/2)+3.3E-10*Bmax^2*twsnap^2/Ds^2 ` 1/s^2)*lambda^2/Ds^2)+NAA^2),FNGCF = Qgcf*NGCF]]){}}={{1.03 \times 10^{+16}}\over{t_{\rm ionsph}}}\;\mathrm{Ops} \\
\m  \mbox{{}gcfrate(SKA1Survey,[Nfacet = 1,twsnap = 550 ` s,Qfcv = 1,Qgcf = 8,[NGCF = sqrt('qty(16*'qty(3.48E-6*Bmax*twsnap*sqrt(Bmax*twsnap/lambda)/Ds ` 1/s^(3/2)+3.3E-10*Bmax^2*twsnap^2/Ds^2 ` 1/s^2)*lambda^2/Ds^2)+NAA^2),FNGCF = Qgcf*NGCF]]){}}={{3.14 \times 10^{+16}}\over{t_{\rm ionsph}}}\;\mathrm{Ops} \\
\end{maxima}
...
\maximaoutput*
\m  \mbox{{}gcfrate(SKA1Low,[Nfacet = 1,twsnap = 40 ` s,Qfcv = 1,Qgcf = 8,[NGCF = sqrt('qty(16*'qty(3.48E-6*Bmax*twsnap*sqrt(Bmax*twsnap/lambda)/Ds ` 1/s^(3/2)+3.3E-10*Bmax^2*twsnap^2/Ds^2 ` 1/s^2)*lambda^2/Ds^2)+NAA^2),FNGCF = Qgcf*NGCF],Tion = 60 ` s]){}}=5.07 \times 10^{+14}\;{{\mathrm{Ops}}\over{\mathrm{s}}} \\
\m  \mbox{{}gcfrate(SKA1Mid,[Nfacet = 1,twsnap = 200 ` s,Qfcv = 1,Qgcf = 8,[NGCF = sqrt('qty(16*'qty(3.48E-6*Bmax*twsnap*sqrt(Bmax*twsnap/lambda)/Ds ` 1/s^(3/2)+3.3E-10*Bmax^2*twsnap^2/Ds^2 ` 1/s^2)*lambda^2/Ds^2)+NAA^2),FNGCF = Qgcf*NGCF],Tion = 60 ` s]){}}=1.72 \times 10^{+14}\;{{\mathrm{Ops}}\over{\mathrm{s}}} \\
\m  \mbox{{}gcfrate(SKA1Survey,[Nfacet = 1,twsnap = 550 ` s,Qfcv = 1,Qgcf = 8,[NGCF = sqrt('qty(16*'qty(3.48E-6*Bmax*twsnap*sqrt(Bmax*twsnap/lambda)/Ds ` 1/s^(3/2)+3.3E-10*Bmax^2*twsnap^2/Ds^2 ` 1/s^2)*lambda^2/Ds^2)+NAA^2),FNGCF = Qgcf*NGCF],Tion = 60 ` s]){}}=5.24 \times 10^{+14}\;{{\mathrm{Ops}}\over{\mathrm{s}}} \\
\end{maxima}
...
\maximaoutput*
\m  {{N_{\rm f}\,\left(72\,\left(N_{\rm a}-1\right)\,N_{\rm a}\,\mathrm{SDft}+256\,N_{\rm a}\,\mathrm{SDft}\right)}\over{t_{\rm dump}}}\;\mathrm{Ops} \\
\m  \mbox{ DFTRate(SKA1Low,[SDft = 10000.]) }=3.2 \times 10^{+17}\;{{\mathrm{Ops}}\over{\mathrm{s}}} \\
\m  \mbox{ DFTRate(SKA1Mid,[SDft = 10000.]) }=1.5 \times 10^{+17}\;{{\mathrm{Ops}}\over{\mathrm{s}}} \\
\m  \mbox{ DFTRate(SKA1Survey,[SDft = 10000.]) }=5.8 \times 10^{+15}\;{{\mathrm{Ops}}\over{\mathrm{s}}} \\
\end{maxima}

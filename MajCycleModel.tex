...
\maximaoutput*
\m  \mathrm{NGWfn}\left(w , \eta\right)\mathbin{:=}2\,\sqrt{\mathrm{qty}\left(\left({{w\,\mathrm{FOVl}}\over{2}}\right)^2+{{{{w\,\mathrm{FOVl}}\over{2}}}\over{{{3.1\,\eta}\over{\sqrt{w}}}}}\right)}\,\mathrm{FOVl} \\
\end{maxima}
...
\maximaoutput*
\m  1 \\
\m  {{15.\,\mathrm{lambdamax}\,\mathrm{Qfov}\,\sqrt{\mathrm{qty}\left({{2.67 \times 10^{-5}\,B_{\rm max}\,\mathrm{lambdamax}\,\mathrm{Qfov}\,\mathrm{twsnap}\,\sqrt{{{B_{\rm max}\,\mathrm{twsnap}}\over{\lambda}}}}\over{\pi\,D_{\rm s}\,\lambda}}\;{{1}\over{\mathrm{s}^{{{3}\over{2}}}}}+{{1.93 \times 10^{-8}\,B_{\rm max}^2\,\mathrm{lambdamax}^2\,\mathrm{Qfov}^2\,\mathrm{twsnap}^2}\over{\pi^2\,D_{\rm s}^2\,\lambda^2}}\;{{1}\over{\mathrm{s}^2}}\right)}}\over{\pi\,D_{\rm s}}} \\
...
\maximaoutput*
\m  {{2000.\,B_{\rm max}^2\,\mathrm{lambdamax}^2\,N_{\rm beam}\,N_{\rm f}\,N_{\rm facet}^2\,\mathrm{QPix}^2\,\mathrm{Qfov}^2\,\log \left({{100.\,B_{\rm max}^2\,\mathrm{lambdamax}^2\,\mathrm{QPix}^2\,\mathrm{Qfov}^2}\over{\pi^2\,D_{\rm s}^2\,\mathrm{lambdamin}^2}}\right)}\over{\pi^2\,\log 2\,D_{\rm s}^2\,\mathrm{lambdamin}^2\,\mathrm{twsnap}}}\;\mathrm{Ops} \\
...
\maximaoutput*
\m  {{20000.\,B_{\rm max}^2\,\mathrm{lambdamax}^2\,N_{\rm beam}\,N_{\rm f}\,N_{\rm facet}^2\,\mathrm{QPix}^2\,\mathrm{Qfov}^2}\over{\pi^2\,D_{\rm s}^2\,\mathrm{lambdamin}^2\,\mathrm{twsnap}}}\;\mathrm{Ops} \\
...
\maximaoutput*
\m  {{16\,\left(N_{\rm a}-1\right)\,N_{\rm a}\,N_{\rm beam}\,N_{\rm f}\,N_{\rm facet}^2\,\left(\mathrm{qty}\left({{230.\,\mathrm{lambdamax}^2\,\mathrm{Qfov}^2\,\mathrm{qty}\left({{2.67 \times 10^{-5}\,B_{\rm max}\,\mathrm{lambdamax}\,\mathrm{Qfov}\,\mathrm{twsnap}\,\sqrt{{{B_{\rm max}\,\mathrm{twsnap}}\over{\lambda}}}}\over{\pi\,D_{\rm s}\,\lambda}}\;{{1}\over{\mathrm{s}^{{{3}\over{2}}}}}+{{1.93 \times 10^{-8}\,B_{\rm max}^2\,\mathrm{lambdamax}^2\,\mathrm{Qfov}^2\,\mathrm{twsnap}^2}\over{\pi^2\,D_{\rm s}^2\,\lambda^2}}\;{{1}\over{\mathrm{s}^2}}\right)}\over{\pi^2\,D_{\rm s}^2}}\right)+N_{\rm AA}^2\right)}\over{t_{\rm dump}}}\;\mathrm{Ops} \\
\m  \mbox{{}GridRate(SKA1Low,[Nfacet = 1]){}}=7.15 \times 10^{+12}\,\left(0.5\,\left(0.05\,\mathrm{twsnap}^2+7.9\,\mathrm{twsnap}^{{{3}\over{2}}}\right)+81.\right)\;{{\mathrm{Ops}}\over{\mathrm{s}}} \\
\m  \mbox{{}GridRate(SKA1Mid,[Nfacet = 1]){}}=3.29 \times 10^{+12}\,\left(0.02\,\left(1.1\,\mathrm{twsnap}^2+170.\,\mathrm{twsnap}^{{{3}\over{2}}}\right)+81.\right)\;{{\mathrm{Ops}}\over{\mathrm{s}}} \\
\m  \mbox{{}GridRate(SKA1Survey,[Nfacet = 1]){}}=4.48 \times 10^{+12}\,\left(0.02\,\left(0.07\,\mathrm{twsnap}^2+22.\,\mathrm{twsnap}^{{{3}\over{2}}}\right)+81.\right)\;{{\mathrm{Ops}}\over{\mathrm{s}}} \\
\end{maxima}
...
\maximaoutput*
\m  \left({{16\,\left(N_{\rm a}-1\right)\,N_{\rm a}\,N_{\rm beam}\,N_{\rm f}\,N_{\rm facet}^2\,\left(\mathrm{qty}\left({{230.\,\mathrm{lambdamax}^2\,\mathrm{Qfov}^2\,\mathrm{qty}\left({{2.67 \times 10^{-5}\,B_{\rm max}\,\mathrm{lambdamax}\,\mathrm{Qfov}\,\mathrm{twsnap}\,\sqrt{{{B_{\rm max}\,\mathrm{twsnap}}\over{\lambda}}}}\over{\pi\,D_{\rm s}\,\lambda}}\;{{1}\over{\mathrm{s}^{{{3}\over{2}}}}}+{{1.93 \times 10^{-8}\,B_{\rm max}^2\,\mathrm{lambdamax}^2\,\mathrm{Qfov}^2\,\mathrm{twsnap}^2}\over{\pi^2\,D_{\rm s}^2\,\lambda^2}}\;{{1}\over{\mathrm{s}^2}}\right)}\over{\pi^2\,D_{\rm s}^2}}\right)+N_{\rm AA}^2\right)}\over{t_{\rm dump}}}+{{2000.\,B_{\rm max}^2\,\mathrm{lambdamax}^2\,N_{\rm beam}\,N_{\rm f}\,N_{\rm facet}^2\,\mathrm{QPix}^2\,\mathrm{Qfov}^2\,\log \left({{100.\,B_{\rm max}^2\,\mathrm{lambdamax}^2\,\mathrm{QPix}^2\,\mathrm{Qfov}^2}\over{\pi^2\,D_{\rm s}^2\,\mathrm{lambdamin}^2}}\right)}\over{\pi^2\,\log 2\,D_{\rm s}^2\,\mathrm{lambdamin}^2\,\mathrm{twsnap}}}+{{20000.\,B_{\rm max}^2\,\mathrm{lambdamax}^2\,N_{\rm beam}\,N_{\rm f}\,N_{\rm facet}^2\,\mathrm{QPix}^2\,\mathrm{Qfov}^2}\over{\pi^2\,D_{\rm s}^2\,\mathrm{lambdamin}^2\,\mathrm{twsnap}}}\right)\;\mathrm{Ops} \\
\m  \left({{16\,\left(N_{\rm a}-1\right)\,N_{\rm a}\,N_{\rm beam}\,N_{\rm f}\,N_{\rm facet}^2\,\left(\mathrm{qty}\left({{230.\,\mathrm{lambdamax}^2\,\mathrm{Qfov}^2\,\mathrm{qty}\left({{2.67 \times 10^{-5}\,B_{\rm max}\,\mathrm{lambdamax}\,\mathrm{Qfov}\,\mathrm{twsnap}\,\sqrt{{{B_{\rm max}\,\mathrm{twsnap}}\over{\lambda}}}}\over{\pi\,D_{\rm s}\,\lambda}}\;{{1}\over{\mathrm{s}^{{{3}\over{2}}}}}+{{1.93 \times 10^{-8}\,B_{\rm max}^2\,\mathrm{lambdamax}^2\,\mathrm{Qfov}^2\,\mathrm{twsnap}^2}\over{\pi^2\,D_{\rm s}^2\,\lambda^2}}\;{{1}\over{\mathrm{s}^2}}\right)}\over{\pi^2\,D_{\rm s}^2}}\right)+N_{\rm AA}^2\right)}\over{\mathrm{GridEps}\,t_{\rm dump}}}+{{2000.\,B_{\rm max}^2\,\mathrm{lambdamax}^2\,N_{\rm beam}\,N_{\rm f}\,N_{\rm facet}^2\,\mathrm{QPix}^2\,\mathrm{Qfov}^2\,\log \left({{100.\,B_{\rm max}^2\,\mathrm{lambdamax}^2\,\mathrm{QPix}^2\,\mathrm{Qfov}^2}\over{\pi^2\,D_{\rm s}^2\,\mathrm{lambdamin}^2}}\right)}\over{\pi^2\,\log 2\,D_{\rm s}^2\,\mathrm{FFTEps}\,\mathrm{lambdamin}^2\,\mathrm{twsnap}}}+{{20000.\,B_{\rm max}^2\,\mathrm{lambdamax}^2\,N_{\rm beam}\,N_{\rm f}\,N_{\rm facet}^2\,\mathrm{QPix}^2\,\mathrm{Qfov}^2}\over{\pi^2\,D_{\rm s}^2\,\mathrm{lambdamin}^2\,\mathrm{twsnap}}}\right)\;\mathrm{Ops} \\
\m  \mathrm{CompRate(SKA1Low)}=\left(7.15 \times 10^{+12}\,N_{\rm facet}^2\,\left(0.5\,\left(0.05\,\mathrm{twsnap}^2+7.9\,\mathrm{twsnap}^{{{3}\over{2}}}\right)+81.\right)\;{{1}\over{\mathrm{s}}}+{{3.64 \times 10^{+17}\,N_{\rm facet}^2}\over{\mathrm{twsnap}}}\right)\;\mathrm{Ops} \\
\m  \mathrm{CompRate(SKA1Mid)}=\left(3.29 \times 10^{+12}\,N_{\rm facet}^2\,\left(0.02\,\left(1.1\,\mathrm{twsnap}^2+170.\,\mathrm{twsnap}^{{{3}\over{2}}}\right)+81.\right)\;{{1}\over{\mathrm{s}}}+{{8.79 \times 10^{+18}\,N_{\rm facet}^2}\over{\mathrm{twsnap}}}\right)\;\mathrm{Ops} \\
\m  \mathrm{CompRate(SKA1Survey)}=\left(4.48 \times 10^{+12}\,N_{\rm facet}^2\,\left(0.02\,\left(0.07\,\mathrm{twsnap}^2+22.\,\mathrm{twsnap}^{{{3}\over{2}}}\right)+81.\right)\;{{1}\over{\mathrm{s}}}+{{1.8 \times 10^{+19}\,N_{\rm facet}^2}\over{\mathrm{twsnap}}}\right)\;\mathrm{Ops} \\
\end{maxima}
...
\maximaoutput*
\m  \mbox{{}CompRate(SKA1Low,[Nfacet = 1,twsnap = 54 ` s]){}}=2.07 \times 10^{+16}\;{{\mathrm{Ops}}\over{\mathrm{s}}} \\
\m  \mbox{{}CompRate(SKA1Mid,[Nfacet = 1,twsnap = 270 ` s]){}}=9.9 \times 10^{+16}\;{{\mathrm{Ops}}\over{\mathrm{s}}} \\
\m  \mbox{{}CompRate(SKA1Survey,[Nfacet = 1,twsnap = 730 ` s]){}}=7.43 \times 10^{+16}\;{{\mathrm{Ops}}\over{\mathrm{s}}} \\
\end{maxima}
...
\maximaoutput*
\m  {{2500.\,B_{\rm max}^2\,\mathrm{lambdamax}^2\,\mathrm{QPix}^2\,\mathrm{Qfov}^2}\over{\pi^2\,D_{\rm s}^2\,\mathrm{lambdamin}^2}}\;\mathrm{byte} \\
\m  {{410.}\over{\pi^2}}\;\mathrm{Gbyte} \\
\m  {{9000.}\over{\pi^2}}\;\mathrm{Gbyte} \\
\m  {{560.}\over{\pi^2}}\;\mathrm{Gbyte} \\
\end{maxima}
...
\maximaoutput*
\m  \mbox{{}gcfrate(SKA1Low,[Nfacet = 1,twsnap = 54 ` s,Qfcv = 1,Qgcf = 8,gcfc1]){}}={{5.69 \times 10^{+17}}\over{t_{\rm ionsph}}}\;\mathrm{Ops} \\
\m  \mbox{{}gcfrate(SKA1Mid,[Nfacet = 1,twsnap = 270 ` s,Qfcv = 1,Qgcf = 8,gcfc1]){}}={{4.31 \times 10^{+17}}\over{t_{\rm ionsph}}}\;\mathrm{Ops} \\
\m  \mbox{{}gcfrate(SKA1Survey,[Nfacet = 1,twsnap = 739 ` s,Qfcv = 1,Qgcf = 8,gcfc1]){}}={{1.18 \times 10^{+18}}\over{t_{\rm ionsph}}}\;\mathrm{Ops} \\
\end{maxima}
...
\m  \mbox{{}CompRateG(SKA1Low,append([Nfacet = 1,twsnap = 40 ` s],GStdCond)){}}=2.11 \times 10^{+17}\;{{\mathrm{Ops}}\over{\mathrm{s}}} \\
\m  \mbox{{}CompRateG(SKA1Mid,append([Nfacet = 1,twsnap = 200 ` s],GStdCond)){}}=9.25 \times 10^{+17}\;{{\mathrm{Ops}}\over{\mathrm{s}}} \\
\m  \mbox{{}CompRateG(SKA1Survey,append([Nfacet = 1,twsnap = 550 ` s],GStdCond)){}}=7.02 \times 10^{+17}\;{{\mathrm{Ops}}\over{\mathrm{s}}} \\
\end{maxima}
...
\m  \mbox{{}ParUnit(SKA1Low,append([Nfacet = 1,twsnap = 40 ` s],GStdCond)){}}=8.26 \times 10^{+11}\;{{\mathrm{Ops}}\over{\mathrm{s}}} \\
\m  \mbox{{}ParUnit(SKA1Mid,append([Nfacet = 1,twsnap = 200 ` s],GStdCond)){}}=3.61 \times 10^{+12}\;{{\mathrm{Ops}}\over{\mathrm{s}}} \\
\m  \mbox{{}ParUnit(SKA1Survey,append([Nfacet = 1,twsnap = 550 ` s],GStdCond)){}}=7.61 \times 10^{+10}\;{{\mathrm{Ops}}\over{\mathrm{s}}} \\
\end{maxima}

...
products):
\begin{maxima}[]
ev(TargetGridSize* Nf *4   , append([Nfacet=1], SKA1Low)) `` Pbyte;
ev(TargetGridSize*Nf * 4 , append([Nfacet=1], SKA1Mid)) `` Pbyte;
ev(TargetGridSize*Nf * 4 , append([Nfacet=1], SKA1Survey)) `` Pbyte;

...
\maximaoutput*
\m  \mathrm{NGWfn}\left(w , \eta\right)\mathbin{:=}{{2\,\sqrt{\left(\left({{w\,\left({{\lambda}\over{D_{\rm s}}}\right)}\over{2}}\right)^2+{{{{w\,\left({{\lambda}\over{D_{\rm s}}}\right)}\over{2}}}\over{{{3.1\,\eta}\over{\sqrt{w}}}}}\right) `` 1}}\over{{{{{D_{\rm s}}\over{\lambda}}}\over{2}}}} \\
\end{maxima}
...
\maximaoutput*
\m  \left({{5\,B_{\rm max}^ {- 2 }\,D_{\rm s}^2\,N_{\rm beam}^ {- 1 }\,N_{\rm f}^ {- 1 }\,N_{\rm facet}^2}\over{384}}\;{{1}\over{\mathrm{byte}}}\right)\,\left({{16\,\left(N_{\rm a}-1\right)\,N_{\rm a}\,N_{\rm beam}\,N_{\rm f}\,N_{\rm facet}^2\,\left(N_{\rm GW}^2+N_{\rm AA}^2\right)}\over{t_{\rm dump}}}\;\mathrm{Ops}+\left({{.012\,B_{\rm max}^3\,N_{\rm beam}\,N_{\rm f}\,\log \left({{16\,B_{\rm max}^2}\over{D_{\rm s}^2\,N_{\rm facet}^2}}\right)}\over{\log 2\,D_{\rm s}^3\,N_{\rm facet}\,N_{\rm GW}}}+{{.12\,B_{\rm max}^3\,N_{\rm beam}\,N_{\rm f}}\over{D_{\rm s}^3\,N_{\rm facet}\,N_{\rm GW}}}\right)\;{{\mathrm{Ops}}\over{\mathrm{s}}}\right) \\
\m  7.88 \times 10^{+9}\;{{\mathrm{Ops}}\over{\mathrm{s}\,\mathrm{Gbyte}}} \\
\m  3.62 \times 10^{+9}\;{{\mathrm{Ops}}\over{\mathrm{s}\,\mathrm{Gbyte}}} \\
\m  1.16 \times 10^{+9}\;{{\mathrm{Ops}}\over{\mathrm{s}\,\mathrm{Gbyte}}} \\
\end{maxima}
...
\maximaoutput*
\m  \left({{358.\,D_{\rm s}^3\,N_{\rm facet}^3\,N_{\rm GW}}\over{B_{\rm max}^3\,N_{\rm beam}\,N_{\rm f}}}\;{{\mathrm{s}}\over{\mathrm{byte}}}\right)\,\left({{16\,\left(N_{\rm a}-1\right)\,N_{\rm a}\,N_{\rm beam}\,N_{\rm f}\,N_{\rm facet}^2\,\left(N_{\rm GW}^2+N_{\rm AA}^2\right)}\over{t_{\rm dump}}}\;\mathrm{Ops}+\left({{.012\,B_{\rm max}^3\,N_{\rm beam}\,N_{\rm f}\,\log \left({{16\,B_{\rm max}^2}\over{D_{\rm s}^2\,N_{\rm facet}^2}}\right)}\over{\log 2\,D_{\rm s}^3\,N_{\rm facet}\,N_{\rm GW}}}+{{.12\,B_{\rm max}^3\,N_{\rm beam}\,N_{\rm f}}\over{D_{\rm s}^3\,N_{\rm facet}\,N_{\rm GW}}}\right)\;{{\mathrm{Ops}}\over{\mathrm{s}}}\right) \\
\m  455.\;{{\mathrm{Ops}}\over{\mathrm{byte}}} \\
\m  261.\;{{\mathrm{Ops}}\over{\mathrm{byte}}} \\
\m  239.\;{{\mathrm{Ops}}\over{\mathrm{byte}}} \\
\end{maxima}
...
\maximaoutput*
\m  {{7.9 \times 10^{+10}\,\mathrm{Ops}}\over{s}} \\
\m  {{1.7 \times 10^{+13}\,\mathrm{Ops}}\over{s}} \\
\m  {{7.8 \times 10^{+11}\,\mathrm{Ops}}\over{s}} \\
\end{maxima}
...
\maximaoutput*
\m  3.8 \times 10^{+15}\;{{\mathrm{Ops}}\over{\mathrm{s}}} \\
\end{maxima}

...
\maximaoutput*
\m  \mathrm{NGWfn}\left(w , \eta\right)\mathbin{:=}{{2\,\sqrt{\mathrm{``}\left(\left({{w\,\left({{\lambda}\over{D_{\rm s}}}\right)}\over{2}}\right)^2+{{{{w\,\left({{\lambda}\over{D_{\rm s}}}\right)}\over{2}}}\over{{{3.1\,\eta}\over{\sqrt{w}}}}} , 1\right)}}\over{{{{{D_{\rm s}}\over{\lambda}}}\over{2}}}} \\
\end{maxima}
...
\maximaoutput*
\m  1 \\
\m  {{27000.\,D_{\rm s}\,N_{\rm facet}\,N_{\rm GW}}\over{B_{\rm max}}}\;\mathrm{s} \\
\m  \mathrm{twsnap(SKA1Low)}=9.6\,N_{\rm facet}\,N_{\rm GW}\;\mathrm{s} \\
\m  \mathrm{twsnap(SKA1Mid)}=2.0\,N_{\rm facet}\,N_{\rm GW}\;\mathrm{s} \\
\m  \mathrm{twsnap(SKA1Survey)}=8.2\,N_{\rm facet}\,N_{\rm GW}\;\mathrm{s} \\
\end{maxima}
...
\maximaoutput*
\m  {{0.01\,B_{\rm max}^3\,N_{\rm beam}\,N_{\rm f}\,\log \left({{16\,B_{\rm max}^2}\over{D_{\rm s}^2\,N_{\rm facet}^2}}\right)}\over{\log 2\,D_{\rm s}^3\,N_{\rm facet}\,N_{\rm GW}}}\;{{\mathrm{Ops}}\over{\mathrm{s}}} \\
\m  \mathrm{FFTRate(SKA1Low)}={{1.0 \times 10^{+14}\,\log \left({{1.3 \times 10^{+8}}\over{N_{\rm facet}^2}}\right)}\over{N_{\rm facet}\,N_{\rm GW}}}\;{{\mathrm{Ops}}\over{\mathrm{s}}} \\
\m  \mathrm{FFTRate(SKA1Mid)}={{1.01 \times 10^{+16}\,\log \left({{2.84 \times 10^{+9}}\over{N_{\rm facet}^2}}\right)}\over{N_{\rm facet}\,N_{\rm GW}}}\;{{\mathrm{Ops}}\over{\mathrm{s}}} \\
\m  \mathrm{FFTRate(SKA1Survey)}={{5.72 \times 10^{+15}\,\log \left({{1.77 \times 10^{+8}}\over{N_{\rm facet}^2}}\right)}\over{N_{\rm facet}\,N_{\rm GW}}}\;{{\mathrm{Ops}}\over{\mathrm{s}}} \\
\m  {{1.29 \times 10^{+15}}\over{\log 2\,N_{\rm GW}}}\;{{\mathrm{Ops}}\over{\mathrm{s}}} \\
\m  {{1.53 \times 10^{+17}}\over{\log 2\,N_{\rm GW}}}\;{{\mathrm{Ops}}\over{\mathrm{s}}} \\
\m  {{7.54 \times 10^{+16}}\over{\log 2\,N_{\rm GW}}}\;{{\mathrm{Ops}}\over{\mathrm{s}}} \\
\end{maxima}
...
\maximaoutput*
\m  {{0.1\,B_{\rm max}^3\,N_{\rm beam}\,N_{\rm f}}\over{D_{\rm s}^3\,N_{\rm facet}\,N_{\rm GW}}}\;{{\mathrm{Ops}}\over{\mathrm{s}}} \\
\m  \mathrm{ReProjRate(SKA1Low)}={{6.94 \times 10^{+14}}\over{N_{\rm facet}\,N_{\rm GW}}}\;{{\mathrm{Ops}}\over{\mathrm{s}}} \\
\m  \mathrm{ReProjRate(SKA1Mid)}={{7.05 \times 10^{+16}}\over{N_{\rm facet}\,N_{\rm GW}}}\;{{\mathrm{Ops}}\over{\mathrm{s}}} \\
...
\m  \mathrm{GridRate(SKA1Low)}=7.15 \times 10^{+12}\,N_{\rm facet}^2\,\left(N_{\rm GW}^2+81.\right)\;{{\mathrm{Ops}}\over{\mathrm{s}}} \\
\m  \mathrm{GridRate(SKA1Mid)}=3.29 \times 10^{+12}\,N_{\rm facet}^2\,\left(N_{\rm GW}^2+81.\right)\;{{\mathrm{Ops}}\over{\mathrm{s}}} \\
\m  \mathrm{GridRate(SKA1Survey)}=4.48 \times 10^{+12}\,N_{\rm facet}^2\,\left(N_{\rm GW}^2+81.\right)\;{{\mathrm{Ops}}\over{\mathrm{s}}} \\
\m  7.15 \times 10^{+12}\,\left(N_{\rm GW}^2+81\right)\;{{\mathrm{Ops}}\over{\mathrm{s}}} \\
\m  3.29 \times 10^{+12}\,\left(N_{\rm GW}^2+81\right)\;{{\mathrm{Ops}}\over{\mathrm{s}}} \\
\m  4.48 \times 10^{+12}\,\left(N_{\rm GW}^2+81\right)\;{{\mathrm{Ops}}\over{\mathrm{s}}} \\
\end{maxima}
...
\maximaoutput*
\m  {{16\,\left(N_{\rm a}-1\right)\,N_{\rm a}\,N_{\rm beam}\,N_{\rm f}\,N_{\rm facet}^2\,\left(N_{\rm GW}^2+N_{\rm AA}^2\right)}\over{t_{\rm dump}}}\;\mathrm{Ops}+\left({{0.01\,B_{\rm max}^3\,N_{\rm beam}\,N_{\rm f}\,\log \left({{16\,B_{\rm max}^2}\over{D_{\rm s}^2\,N_{\rm facet}^2}}\right)}\over{\log 2\,D_{\rm s}^3\,N_{\rm facet}\,N_{\rm GW}}}+{{0.1\,B_{\rm max}^3\,N_{\rm beam}\,N_{\rm f}}\over{D_{\rm s}^3\,N_{\rm facet}\,N_{\rm GW}}}\right)\;{{\mathrm{Ops}}\over{\mathrm{s}}} \\
\m  \mathrm{CompRate(SKA1Low)}=\left(7.15 \times 10^{+12}\,N_{\rm facet}^2\,\left(N_{\rm GW}^2+81.\right)+{{1.0 \times 10^{+14}\,\log \left({{1.3 \times 10^{+8}}\over{N_{\rm facet}^2}}\right)}\over{N_{\rm facet}\,N_{\rm GW}}}+{{6.94 \times 10^{+14}}\over{N_{\rm facet}\,N_{\rm GW}}}\right)\;{{\mathrm{Ops}}\over{\mathrm{s}}} \\
\m  \mathrm{CompRate(SKA1Mid)}=\left(3.29 \times 10^{+12}\,N_{\rm facet}^2\,\left(N_{\rm GW}^2+81.\right)+{{1.01 \times 10^{+16}\,\log \left({{2.84 \times 10^{+9}}\over{N_{\rm facet}^2}}\right)}\over{N_{\rm facet}\,N_{\rm GW}}}+{{7.05 \times 10^{+16}}\over{N_{\rm facet}\,N_{\rm GW}}}\right)\;{{\mathrm{Ops}}\over{\mathrm{s}}} \\
\m  \mathrm{CompRate(SKA1Survey)}=\left(4.48 \times 10^{+12}\,N_{\rm facet}^2\,\left(N_{\rm GW}^2+81.\right)+{{5.72 \times 10^{+15}\,\log \left({{1.77 \times 10^{+8}}\over{N_{\rm facet}^2}}\right)}\over{N_{\rm facet}\,N_{\rm GW}}}+{{3.97 \times 10^{+16}}\over{N_{\rm facet}\,N_{\rm GW}}}\right)\;{{\mathrm{Ops}}\over{\mathrm{s}}} \\
\end{maxima}
...
\m  \left[ N_{\rm GW}=17.\,\left(1.7\,i-1.0\right) , N_{\rm GW}=-17.\,\left(1.7\,i+1.0\right) , N_{\rm GW}=35. \right] \\
...
\maximaoutput*
\m  1.26 \times 10^{+15}\;{{\mathrm{Ops}}\over{\mathrm{s}}} \\
\m  1.26 \times 10^{+16}\;{{\mathrm{Ops}}\over{\mathrm{s}}} \\
...
\maximaoutput*
\m  \left({{\left(N_{\rm a}-1\right)^ {- 1 }\,N_{\rm a}^ {- 1 }\,N_{\rm beam}^ {- 1 }\,N_{\rm f}^ {- 1 }\,t_{\rm dump}}\over{16}}\;{{1}\over{\mathrm{byte}}}\right)\,\left({{16\,\left(N_{\rm a}-1\right)\,N_{\rm a}\,N_{\rm beam}\,N_{\rm f}\,N_{\rm facet}^2\,\left(N_{\rm GW}^2+N_{\rm AA}^2\right)}\over{t_{\rm dump}}}\;\mathrm{Ops}+\left({{0.01\,B_{\rm max}^3\,N_{\rm beam}\,N_{\rm f}\,\log \left({{16\,B_{\rm max}^2}\over{D_{\rm s}^2\,N_{\rm facet}^2}}\right)}\over{\log 2\,D_{\rm s}^3\,N_{\rm facet}\,N_{\rm GW}}}+{{0.1\,B_{\rm max}^3\,N_{\rm beam}\,N_{\rm f}}\over{D_{\rm s}^3\,N_{\rm facet}\,N_{\rm GW}}}\right)\;{{\mathrm{Ops}}\over{\mathrm{s}}}\right) \\
\m  170.\;{{\mathrm{Ops}}\over{\mathrm{byte}}} \\
\m  3800.\;{{\mathrm{Ops}}\over{\mathrm{byte}}} \\
\m  2000.\;{{\mathrm{Ops}}\over{\mathrm{byte}}} \\
\end{maxima}
...
\maximaoutput*
\m  \left({{5\,B_{\rm max}^ {- 2 }\,D_{\rm s}^2\,N_{\rm beam}^ {- 1 }\,N_{\rm f}^ {- 1 }\,N_{\rm facet}^2}\over{384}}\;{{1}\over{\mathrm{byte}}}\right)\,\left({{16\,\left(N_{\rm a}-1\right)\,N_{\rm a}\,N_{\rm beam}\,N_{\rm f}\,N_{\rm facet}^2\,\left(N_{\rm GW}^2+N_{\rm AA}^2\right)}\over{t_{\rm dump}}}\;\mathrm{Ops}+\left({{0.01\,B_{\rm max}^3\,N_{\rm beam}\,N_{\rm f}\,\log \left({{16\,B_{\rm max}^2}\over{D_{\rm s}^2\,N_{\rm facet}^2}}\right)}\over{\log 2\,D_{\rm s}^3\,N_{\rm facet}\,N_{\rm GW}}}+{{0.1\,B_{\rm max}^3\,N_{\rm beam}\,N_{\rm f}}\over{D_{\rm s}^3\,N_{\rm facet}\,N_{\rm GW}}}\right)\;{{\mathrm{Ops}}\over{\mathrm{s}}}\right) \\
\m  7.87 \times 10^{+9}\;{{\mathrm{Ops}}\over{\mathrm{s}\,\mathrm{Gbyte}}} \\
\m  3.61 \times 10^{+9}\;{{\mathrm{Ops}}\over{\mathrm{s}\,\mathrm{Gbyte}}} \\
\m  1.15 \times 10^{+9}\;{{\mathrm{Ops}}\over{\mathrm{s}\,\mathrm{Gbyte}}} \\
\end{maxima}
...
\maximaoutput*
\m  \left({{350.\,D_{\rm s}^3\,N_{\rm facet}^3\,N_{\rm GW}}\over{B_{\rm max}^3\,N_{\rm beam}\,N_{\rm f}}}\;{{\mathrm{s}}\over{\mathrm{byte}}}\right)\,\left({{16\,\left(N_{\rm a}-1\right)\,N_{\rm a}\,N_{\rm beam}\,N_{\rm f}\,N_{\rm facet}^2\,\left(N_{\rm GW}^2+N_{\rm AA}^2\right)}\over{t_{\rm dump}}}\;\mathrm{Ops}+\left({{0.01\,B_{\rm max}^3\,N_{\rm beam}\,N_{\rm f}\,\log \left({{16\,B_{\rm max}^2}\over{D_{\rm s}^2\,N_{\rm facet}^2}}\right)}\over{\log 2\,D_{\rm s}^3\,N_{\rm facet}\,N_{\rm GW}}}+{{0.1\,B_{\rm max}^3\,N_{\rm beam}\,N_{\rm f}}\over{D_{\rm s}^3\,N_{\rm facet}\,N_{\rm GW}}}\right)\;{{\mathrm{Ops}}\over{\mathrm{s}}}\right) \\
\m  450.\;{{\mathrm{Ops}}\over{\mathrm{byte}}} \\
\m  260.\;{{\mathrm{Ops}}\over{\mathrm{byte}}} \\
\m  230.\;{{\mathrm{Ops}}\over{\mathrm{byte}}} \\
\end{maxima}
...
\maximaoutput*
\m  {{7.92 \times 10^{+10}\,\mathrm{Ops}}\over{s}} \\
\m  {{1.72 \times 10^{+13}\,\mathrm{Ops}}\over{s}} \\
\m  {{7.76 \times 10^{+11}\,\mathrm{Ops}}\over{s}} \\
\end{maxima}
...
\maximaoutput*
\m  {{30.}\over{t_{\rm ionsph}}}\;\mathrm{s} \\
\m  {{5.2}\over{t_{\rm ionsph}}}\;\mathrm{s} \\
\m  {{18.}\over{t_{\rm ionsph}}}\;\mathrm{s} \\
\end{maxima}
...
\maximaoutput*
\m  {{2.58 \times 10^{+16}}\over{t_{\rm ionsph}}}\;\mathrm{Ops} \\
\m  {{2.24 \times 10^{+16}}\over{t_{\rm ionsph}}}\;\mathrm{Ops} \\
\m  {{5.87 \times 10^{+16}}\over{t_{\rm ionsph}}}\;\mathrm{Ops} \\
\end{maxima}
...
\m  3.74 \times 10^{+14}\;{{\mathrm{Ops}}\over{\mathrm{s}}} \\
\m  9.78 \times 10^{+14}\;{{\mathrm{Ops}}\over{\mathrm{s}}} \\
\end{maxima}
...
\maximaoutput*
\m  \left[ N_{\rm GW}=12.\,\left(1.7\,i-1.0\right) , N_{\rm GW}=-12.\,\left(1.7\,i+1.0\right) , N_{\rm GW}=24. \right] \\
\end{maxima}
...
\maximaoutput*
\m  3.82 \times 10^{+15}\;{{\mathrm{Ops}}\over{\mathrm{s}}} \\
\end{maxima}
...
\maximaoutput*
\m  \mathbf{true} \\
\m  {{16\,\left(N_{\rm a}-1\right)\,N_{\rm a}\,N_{\rm beam}\,N_{\rm f}\,N_{\rm facet}^2\,\left(N_{\rm GW}^2+N_{\rm AA}^2\right)}\over{t_{\rm dump}}}\;\mathrm{Ops}+\left({{0.01\,B_{\rm max}^3\,N_{\rm beam}\,N_{\rm f}\,\log \left({{16\,B_{\rm max}^2}\over{D_{\rm s}^2\,N_{\rm facet}^2}}\right)}\over{\log 2\,D_{\rm s}^3\,N_{\rm facet}\,N_{\rm GW}}}+{{0.1\,B_{\rm max}^3\,N_{\rm beam}\,N_{\rm f}}\over{D_{\rm s}^3\,N_{\rm facet}\,N_{\rm GW}}}\right)\;{{\mathrm{Ops}}\over{\mathrm{s}}}=\left({{{{320\,B_{\rm max}^2\,N_{\rm beam}\,N_{\rm f}\,\log \left({{16\,B_{\rm max}^2}\over{D_{\rm s}^2\,N_{\rm facet}^2}}\right)\,\mathrm{wsNWPlanes}}\over{\log 2\,D_{\rm s}^2}}+{{3200\,B_{\rm max}^2\,N_{\rm beam}\,N_{\rm f}\,\mathrm{wsNWPlanes}}\over{D_{\rm s}^2}}}\over{\mathrm{tobs}}}+{{8\,\left(N_{\rm a}-1\right)\,N_{\rm a}\,N_{\rm beam}\,N_{\rm f}\,N_{\rm facet}^2\,\left({{B_{\rm max}^2}\over{4\,D_{\rm s}^2\,N_{\rm facet}^2\,\mathrm{wsNWPlanes}^2}}+N_{\rm AA}^2\right)}\over{t_{\rm dump}}}\right)\;\mathrm{Ops} \\

(function(jFN){
    var jSF = jQuery.sheet.skafn = {
		...
		AVFACTORFIXED:function (bmax,diam,oversamp,arr2,freq,bw,dvel,arr) { 
			/*  To return an averaging factor for the effect that some baselines are shorter
				and so do not need a fast sampling time and narrow channel width */
		...
		PARASELECT:function (arr1,arr2){
			if (arr1=="Low"){
				if (arr2=="Nant") return 1024;
				else if (arr2=="Nbeam") return 1;
				else if (arr2=="Diam (m)") return 35;
				else if (arr2=="Bmax (km)") return 70;
			} else if (arr1=="Mid"){
				if (arr2=="Nant") return 254;
				else if (arr2=="Nbeam") return 1;
				else if (arr2=="Diam (m)") return 15;
				else if (arr2=="Bmax (km)") return 200;
			} else if (arr1=="Survey"){
				if (arr2=="Nant") return 96;
				else if (arr2=="Nbeam") return 36;
				else if (arr2=="Diam (m)") return 15;
				else if (arr2=="Bmax (km)") return 50;
			}
		},
		SNF:function (n) {    
			var num=Number(n);
